...
public class WrapperFilterIsLayoutedInnerNewNotOldReverse implements FilterFunction<Row> {
	...
	public WrapperFilterIsLayoutedInnerNewNotOldReverse(Map<String,VertexVDrive> layoutedVertices,
