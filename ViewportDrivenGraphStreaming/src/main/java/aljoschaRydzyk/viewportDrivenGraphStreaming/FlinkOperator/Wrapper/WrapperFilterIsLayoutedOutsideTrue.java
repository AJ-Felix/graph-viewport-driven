...
public class WrapperFilterIsLayoutedOutsideTrue implements FilterFunction<Row> {
	...
	public WrapperFilterIsLayoutedOutsideTrue (Map<String,VertexVDrive> layoutedVertices, Float topModel, Float rightModel, Float bottomModel, 
			Float leftModel) {
